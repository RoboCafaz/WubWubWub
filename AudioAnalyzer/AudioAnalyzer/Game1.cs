...
namespace AudioAnalyzer
{
	...
	public class Game1 : Microsoft.Xna.Framework.Game
	{
		...
		public Game1()
		{
            ...
            TargetElapsedTime = new TimeSpan(0, 0, 0, 0, 9);
		}
		...
		protected override void Initialize()
		{
            ...
            soundSpectrum.AudioEvent += (s, e) => eventVisuals.CreateEvent(e);
		...
		protected override void Draw(GameTime gameTime)
		{
            ...
            spriteBatch.Begin();
            soundSpectrum.Draw(spriteBatch);
            eventVisuals.Draw(spriteBatch);
            spriteBatch.End();
